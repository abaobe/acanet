...
--
-- Host: localhost
-- Generation Time: May 20, 2011 at 05:58 PM
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  `date_time` datetime NOT NULL,
  PRIMARY KEY (`news_id`),
  KEY `publisher_id` (`publiser_name`)
...
INSERT INTO `news` (`news_id`, `heading`, `content`, `type`, `publiser_name`, `date_time`) VALUES
(4, 'this is news 1', 'content 1', 'ajaira', 'giga', '2011-05-07 23:55:58');
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `news_ibfk_1` FOREIGN KEY (`publiser_name`) REFERENCES `user` (`username`) ON UPDATE CASCADE;
