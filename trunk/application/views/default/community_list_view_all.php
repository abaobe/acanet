...
<?php endforeach; ?>
                ...
                <!-- Content unit - One column -->
                <h1 class="block"><a href="<?= site_url("/community_list/index/group") ?>">Public communities</a></h1>
                <div class="column1-unit">
                    <table>
                        <tr>
                            <th class="top" scope="col" style="width:200px;">Name</th>
...
<?php foreach ($query5_result as $row): ?>
                            <tr><th scope="row">
                                    <a href="<?= site_url("/community/index/$row->community_id") ?>">
<?php echo $row->name; ?>
                        </a>
...
<?php endforeach; ?>
                        ...
                        <a  href="<?= site_url("/community_list/index/group") ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  More ...</a>
</div>
<hr class="clear-contentunit" />