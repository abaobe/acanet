...
--
-- Host: localhost
-- Generation Time: Apr 20, 2011 at 06:37 PM
...
INSERT INTO `institution` (`institution_id`, `name`, `short_name`, `location`, `community_id`, `campuses`, `short_description`, `updated_date`) VALUES
(0, 'no name', '', '', 0, '', 'It is a dummy institution for global fields', '2011-04-20 17:55:10'),
(1, 'Bangladesh Institution of Engineering and Technology', 'BUET', 'polashi,Dhaka', 1, 'BUET has only one campus in Polashi', 'It is the best university in Bangladesh', '2011-04-20 17:44:49'),
(2, 'Dhaka University', 'DU', 'Dhaka', 2, 'It has only one campus in Dhaka', 'It is one of the oldest university in Bangladesh. It is called the Oxford of the East.', '2011-04-20 17:46:21');
